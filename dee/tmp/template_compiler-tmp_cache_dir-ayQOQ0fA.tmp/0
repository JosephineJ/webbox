...
function program1(depth0,data) {
  ...
  data.buffer.push("\n		</div>\n		<div class=\"part-1\">\n			<div class=\"content-box\">\n				<h3>So many headers...</h3>\n				<p>Content</p>\n				<h3>Too many headers</h3>\n				<p>And I will never read them</p>\n			</div>\n		</div>\n	</div>\n</section>\n\n\n");
